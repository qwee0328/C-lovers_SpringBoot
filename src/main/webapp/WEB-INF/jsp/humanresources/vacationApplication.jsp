...
<link rel="stylesheet" href="/css/humanresources/vacationApplication.css">
<script type="text/javascript" src="/js/humanresources/flatpickr.js"></script>
<script type="text/javascript" src="/js/humanresources/vacationApplication.js"></script>
</head>
<body>
...
<div class="container">
    ...
    <div class="vacationApp">
        <div class="draftingBtn">
            <button class="noneBackgroundBtn">기안하기</button>
        </div>
        ...
        <div class="approvalLine">
            <div class="title">
                결재선<button class="noneBackgroundBtn">결재선 설정</button>
            </div>
        ...
        <div class="vacationStatus">
            ...
            <div class="vacationInfo">
                <div class="vacationInfo__main">잔여휴가 <span>20일</span>(연차 20일)</div>
                <div class="vacationInfo__sub">
                    ...
                    <div class="sub__label">
                        <div class="usedVacation"></div>사용한 휴가 <div class="selectedVacation"></div>선택한 날짜
                    </div>
                </div>
            </div>

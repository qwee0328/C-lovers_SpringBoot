    ...
    <div class="container">
        <div class="addBook__header">
            <div class="header__searchBar d-flex">
                <div class="searchBar__icon"><i class="fa-solid fa-magnifying-glass align-center"></i></div>
                <div class="searchBar__inputCover d-flex"><input type="text" class="searchBar__input" placeholder="이름, 회사명, 전화번호 검색"></div>
            </div>
        </div>
        <div class="addBook__body">
            <div class="body__addListHeader d-flex">
                <div class="addListHeader__chkBoxCover align-center"><input type="checkbox" class="addListHeader__chkBox"></div>
            ...
            <div class="body__addList">
                <div class="addList__addessLine d-flex">
                    <div class="addessLine__chkBoxCover align-center"><input type="checkbox" class="addessLine__chkBox"></div>
                    <div class="addessLint__favorites align-center"><i class="fa-regular fa-star align-center favorites__icon"></i></div>
                    ...
                    <div class="addessLine__tag d-flex"><div class="addBook__tag align-center">ceo</div></div>
                </div>
            </div>
            <div class="body__addList">
                <div class="addList__addessLine d-flex">
